        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryImage = table.Column<byte[]>(type: "longblob", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MethodImage = table.Column<byte[]>(type: "longblob", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Eater", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MomoPayment = table.Column<string>(type: "longtext", nullable: false),
                    Coordinator = table.Column<string>(type: "longtext", nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
                    AccountId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coordinator = table.Column<string>(type: "longtext", nullable: false),
                    Default = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    EaterId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodImage = table.Column<byte[]>(type: "longblob", nullable: false),
                    FoodDescribe = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentFee = table.Column<double>(type: "double", nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Eater_AccountId",
                table: "Eater",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Food_MerchantId",
                table: "Food",
                column: "MerchantId");

            migrationBuilder.CreateIndex(
                name: "IX_Location_EaterId",
                table: "Location",
                column: "EaterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Merchant_AccountId",
                table: "Merchant",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Merchant_CategoryId",
                table: "Merchant",
                column: "CategoryId");
